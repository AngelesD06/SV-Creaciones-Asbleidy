...
public class productos_nodisponibles extends javax.swing.JFrame {

    public static DefaultTableModel modelo;
    
    public productos_nodisponibles() {
    ...
    private void initComponents() {
        ...
        tabland = new javax.swing.JTable();
        ...
        tabland.setFont(new java.awt.Font("Calibri", 0, 14)); // NOI18N
        tabland.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null, null},
                {null, null, null, null},
                {null, null, null, null},
        ...
        tabland.setSelectionBackground(new java.awt.Color(221, 98, 34));
        jScrollPane1.setViewportView(tabland);
        ...
        lblProductos.setText("Productos no disponibles");
        pnlPrincipal.add(lblProductos, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 120, -1, 76));
    ...
    //Método para llenar la tabla con los productos que no están disponibles en la base de datos
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(productos_nodisponibles.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new productos_nodisponibles().setVisible(true);
            }
        });
    }
    ...
    public static javax.swing.JTable tabland;
