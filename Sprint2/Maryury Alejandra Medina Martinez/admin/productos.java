...
public class productos extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        txtBuscar.setBotonColor(new java.awt.Color(0, 0, 0));
    ...
    private void btnModificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnModificarActionPerformed
        //Se llama al JFrame que es para modificar_producto un producto 
        int f;
        modificar_producto m = new modificar_producto();
        try {
            f = tablap.getSelectedRow();
            ...
            if (f == -1) {
                ...
                m.txtImagen.setText(String.valueOf(tablap.getValueAt(f, 3)));
                m.setVisible(true);
                dispose();
            }
        } catch (Exception e) {
