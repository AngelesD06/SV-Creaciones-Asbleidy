...
public class modificar_producto extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        txtImagen = new rojeru_san.RSMTextFull();
        ...
        txtCodigo.setBotonColor(new java.awt.Color(0, 0, 0));
        ...
        txtPrecio.setBotonColor(new java.awt.Color(0, 0, 0));
        ...
        txtImagen.setBordeColorFocus(new java.awt.Color(221, 98, 34));
        txtImagen.setBordeColorNoFocus(new java.awt.Color(221, 98, 34));
        txtImagen.setBotonColor(new java.awt.Color(255, 255, 255));
        txtImagen.setDisabledTextColor(new java.awt.Color(221, 98, 34));
        txtImagen.setFont(new java.awt.Font("Calibri", 0, 14)); // NOI18N
        txtImagen.setModoMaterial(true);
        txtImagen.setPlaceholder("Imagen");
        pnlPrincipal.add(txtImagen, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 390, 260, 40));
    ...
    private void txtPrecioKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtPrecioKeyTyped
        //Solo deja ingresar números en la caja de texto del precio
        char num = evt.getKeyChar();
        if ((num < '0' || num > '9')) {
            evt.consume();
        }
    ...
    private void btnBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuscarActionPerformed
        ...
        File ruta1 = new File("C:\\Users\\Lenovo\\Documents\\NetBeansProjects\\Creaciones_Asbleidy\\src\\fotos");
    ...
    private void btnModificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnModificarActionPerformed
        ...
        if (c.equals("") || n.equals("") || p.equals("") || i.equals("")) {
            ...
            try {
                ...
                //Instrucción de actualizar
                FileInputStream archivofoto = new FileInputStream(i);
                String sql = "UPDATE producto SET nombre=?," + "precio=?," + "ruta=?," + "imagen=?" + " WHERE codigo='" + c + "' ";
    ...
    public rojeru_san.RSMTextFull txtImagen;
